...
try {
    ...
    // keywordパラメータの値が存在すれば（書籍名を検索した時）、その値を変数$keywordに代入
...
<body>
    ...
    <main>
        <article class="books">
            ...
            if (isset($_GET['message'])) {
                echo "<p class='succses'>{$_GET['message']}</p>";
            }
            ?>
            <div class="books-ui">
                <div>
    ...
    <footer>
        <p class="copyright">&copy; 書籍一覧アプリ All rights reserved.</p>
    </footer>
</body>
